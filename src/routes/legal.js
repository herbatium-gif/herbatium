...
function confidentialitate(v) {
  ...
  <table>
    ...
    <tr><td>Salvarea rețetelor, stocului, loturilor, produselor și funcționarea aplicației</td><td>executarea contractului, art. 6 alin. (1) lit. b)</td><td>până ștergi tu datele sau contul</td></tr>
  ...
  <table>
    ...
    <tr><td>Furnizorul de găzduire [completează]</td><td>serverul aplicației și baza de date</td><td>[completează țara]</td></tr>
...
function termeni(v) {
  ...
  <h2>8. Litigii</h2>
  <p>Poți depune o reclamație la Autoritatea Națională pentru Protecția Consumatorilor (ANPC, <a href="https://anpc.ro" target="_blank" rel="noopener">anpc.ro</a>) sau prin platforma de Soluționare Alternativă a Litigiilor (SAL, <a href="https://reclamatiisal.anpc.ro" target="_blank" rel="noopener">reclamatiisal.anpc.ro</a>).</p>
